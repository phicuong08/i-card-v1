...
package com.assist {
    ...
    public class URI {
        ...
        private static var _domain:String = "115.182.65.220";//"4x001.xd.com";
        private static var _serverPort:int = 8002;//8000;
        private static var _clientUrl:String = "";//"http://sxd.xdcdn.net/2012032401/";
