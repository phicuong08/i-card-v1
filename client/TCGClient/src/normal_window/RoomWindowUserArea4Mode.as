...
package normal_window {
    ...
    public class RoomWindowUserArea4Mode extends RoomWindowUserArea implements IBindingClient {
		use namespace mx_internal;
        private static var _watcherSetupUtil:IWatcherSetupUtil2;

        public var _RoomWindowUserArea4Mode_CommonHeadImageFrame1:CommonHeadImageFrame;
        public var _RoomWindowUserArea4Mode_CommonMiddleFrame1:CommonMiddleFrame;
        public var _RoomWindowUserArea4Mode_CommonOuterFrame1:CommonOuterFrame;
        public var _RoomWindowUserArea4Mode_WordWithCircle1:WordWithCircle;
        ...
        public function RoomWindowUserArea4Mode(){
            var target:* = null;
            var watcherSetupUtilClass:* = null;
            this._1059420975userCardGroups = new ArrayCollection();
            this._embed_mxml_source_commonUI____png_1538356188 = RoomWindowUserArea4Mode__embed_mxml_source_commonUI____png_1538356188;
            this._embed_mxml_source_commonUI_______png_425445134 = RoomWindowUserArea4Mode__embed_mxml_source_commonUI_______png_425445134;
            this._bindings = [];
            this._watchers = [];
            this._bindingsByDestination = {};
            this._bindingsBeginWithWord = {};
            super();
            var bindings:* = this._RoomWindowUserArea4Mode_bindingsSetup();
            var watchers:* = [];
            target = this;
            if (_watcherSetupUtil == null){
                watcherSetupUtilClass = getDefinitionByName("_normal_window_RoomWindowUserArea4ModeWatcherSetupUtil");
            ...
            _watcherSetupUtil.setup(this, function (_arg1:String){
                ...
                return (RoomWindowUserArea4Mode[_arg1]);
            }, bindings, watchers);
            mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
            mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
            this.width = 350;
            this.height = 321;
            this.mxmlContent = [this._RoomWindowUserArea4Mode_CommonOuterFrame1_i(), this._RoomWindowUserArea4Mode_CommonMiddleFrame1_i(), this._RoomWindowUserArea4Mode_SmoothBitmapImage1_c(), this._RoomWindowUserArea4Mode_SmoothBitmapImage2_i(), this._RoomWindowUserArea4Mode_SmoothBitmapImage3_c(), this._RoomWindowUserArea4Mode_SmoothBitmapImage4_c(), this._RoomWindowUserArea4Mode_SmoothBitmapImage5_i(), this._RoomWindowUserArea4Mode_CommonHeadImageFrame1_i(), this._RoomWindowUserArea4Mode_WordWithCircle1_i(), this._RoomWindowUserArea4Mode_Label2_i(), this._RoomWindowUserArea4Mode_Label3_i(), this._RoomWindowUserArea4Mode_Label4_i(), this._RoomWindowUserArea4Mode_Button2_i()];
            this._RoomWindowUserArea4Mode_Fade1_i();
            this._RoomWindowUserArea4Mode_MyImage1_i();
            this._RoomWindowUserArea4Mode_SmoothImage1_i();
            this._RoomWindowUserArea4Mode_Group1_i();
            this._RoomWindowUserArea4Mode_Fade2_i();
            this.addEventListener("creationComplete", this.___RoomWindowUserArea4Mode_RoomWindowUserArea1_creationComplete);
            var i:* = 0;
        ...
        public static function set watcherSetupUtil(_arg1:IWatcherSetupUtil2):void{
            RoomWindowUserArea4Mode._watcherSetupUtil = _arg1;
        }
        ...
        private function displayUserInfo():void{
            if (((_userInfo) && (this.creationHasComplete))){
                isEmpty = false;
                this.userName.text = ("名称:" + _userInfo.name);
                this.userLevel.text = (("等级:" + _userInfo.level) + " 级");
        ...
        private function setPrepareOkSign(_arg1:Boolean, _arg2:String=null):void{
            if (_arg1){
                ...
                this.showUserPrepare(false);
                this.selectCardDesc.text = (_arg2) ? ("卡组：" + _arg2) : null;
            } else {
                if (this.prepareOkImg.parent == this){
        ...
        private function _RoomWindowUserArea4Mode_Fade1_i():Fade{
        ...
        private function _RoomWindowUserArea4Mode_MyImage1_i():MyImage{
            var _local1:MyImage;
            _local1 = new MyImage();
            _local1.x = 26;
            _local1.y = 58.5;
        ...
        private function _RoomWindowUserArea4Mode_SmoothImage1_i():SmoothImage{
        ...
        private function _RoomWindowUserArea4Mode_Group1_i():Group{
            var _local1:Group = new Group();
            _local1.visible = false;
            _local1.mxmlContent = [this._RoomWindowUserArea4Mode_Label1_c(), this._RoomWindowUserArea4Mode_ComboBox1_i(), this._RoomWindowUserArea4Mode_Button1_c(), this._RoomWindowUserArea4Mode_ClickScaleButton1_i()];
        ...
        private function _RoomWindowUserArea4Mode_Label1_c():Label{
        ...
        private function _RoomWindowUserArea4Mode_ComboBox1_i():ComboBox{
        ...
        private function _RoomWindowUserArea4Mode_Button1_c():Button{
            ...
            _local1.addEventListener("click", this.___RoomWindowUserArea4Mode_Button1_click);
            if (!_local1.document){
                _local1.document = this;
            };
            BindingManager.executeBindings(this, "temp", _local1);
        ...
        public function ___RoomWindowUserArea4Mode_Button1_click(_arg1:MouseEvent):void{
            TCGClient.getInstance().enterJudgeCardsWindow("roomWindow");
        }
        private function _RoomWindowUserArea4Mode_ClickScaleButton1_i():ClickScaleButton{
        ...
        private function _RoomWindowUserArea4Mode_Fade2_i():Fade{
            var _local1:Fade = new Fade();
            _local1.alphaFrom = 0;
            _local1.alphaTo = 1;
            _local1.duration = 300;
        ...
        private function _RoomWindowUserArea4Mode_CommonOuterFrame1_i():CommonOuterFrame{
            var _local1:CommonOuterFrame = new CommonOuterFrame();
            _local1.filters = [this._RoomWindowUserArea4Mode_DropShadowFilter1_c()];
            _local1.id = "_RoomWindowUserArea4Mode_CommonOuterFrame1";
            if (!_local1.document){
                _local1.document = this;
            };
            this._RoomWindowUserArea4Mode_CommonOuterFrame1 = _local1;
            BindingManager.executeBindings(this, "_RoomWindowUserArea4Mode_CommonOuterFrame1", this._RoomWindowUserArea4Mode_CommonOuterFrame1);
            return (_local1);
        }
        private function _RoomWindowUserArea4Mode_DropShadowFilter1_c():DropShadowFilter{
        ...
        private function _RoomWindowUserArea4Mode_CommonMiddleFrame1_i():CommonMiddleFrame{
            var _local1:CommonMiddleFrame = new CommonMiddleFrame();
            _local1.x = 12;
            _local1.y = 48;
            _local1.alpha = 0.5;
            _local1.id = "_RoomWindowUserArea4Mode_CommonMiddleFrame1";
            if (!_local1.document){
                _local1.document = this;
            };
            this._RoomWindowUserArea4Mode_CommonMiddleFrame1 = _local1;
            BindingManager.executeBindings(this, "_RoomWindowUserArea4Mode_CommonMiddleFrame1", this._RoomWindowUserArea4Mode_CommonMiddleFrame1);
            return (_local1);
        }
        private function _RoomWindowUserArea4Mode_SmoothBitmapImage1_c():SmoothBitmapImage{
        ...
        private function _RoomWindowUserArea4Mode_SmoothBitmapImage2_i():SmoothBitmapImage{
            var _local1:SmoothBitmapImage = new SmoothBitmapImage();
            _local1.x = 15;
            _local1.y = 14;
        ...
        private function _RoomWindowUserArea4Mode_SmoothBitmapImage3_c():SmoothBitmapImage{
            var _local1:SmoothBitmapImage = new SmoothBitmapImage();
        ...
        private function _RoomWindowUserArea4Mode_SmoothBitmapImage4_c():SmoothBitmapImage{
            var _local1:SmoothBitmapImage = new SmoothBitmapImage();
            _local1.source = this._embed_mxml_source_commonUI_______png_425445134;
            _local1.x = 205;
            _local1.y = 106;
        ...
        private function _RoomWindowUserArea4Mode_SmoothBitmapImage5_i():SmoothBitmapImage{
            var _local1:SmoothBitmapImage = new SmoothBitmapImage();
            _local1.x = 26;
            _local1.y = 58.5;
            _local1.width = 170;
        ...
        private function _RoomWindowUserArea4Mode_CommonHeadImageFrame1_i():CommonHeadImageFrame{
            var _local1:CommonHeadImageFrame = new CommonHeadImageFrame();
            _local1.x = 24;
            _local1.y = 57;
            _local1.depth = 5;
            _local1.id = "_RoomWindowUserArea4Mode_CommonHeadImageFrame1";
            if (!_local1.document){
                _local1.document = this;
            };
            this._RoomWindowUserArea4Mode_CommonHeadImageFrame1 = _local1;
            BindingManager.executeBindings(this, "_RoomWindowUserArea4Mode_CommonHeadImageFrame1", this._RoomWindowUserArea4Mode_CommonHeadImageFrame1);
            return (_local1);
        }
        private function _RoomWindowUserArea4Mode_WordWithCircle1_i():WordWithCircle{
            ...
            _local1.scaleX = 1.2;
            _local1.scaleY = 1.2;
            _local1.filters = [this._RoomWindowUserArea4Mode_GlowFilter1_c()];
            _local1.id = "_RoomWindowUserArea4Mode_WordWithCircle1";
            if (!_local1.document){
                _local1.document = this;
            };
            this._RoomWindowUserArea4Mode_WordWithCircle1 = _local1;
            BindingManager.executeBindings(this, "_RoomWindowUserArea4Mode_WordWithCircle1", this._RoomWindowUserArea4Mode_WordWithCircle1);
            return (_local1);
        }
        private function _RoomWindowUserArea4Mode_GlowFilter1_c():GlowFilter{
            var _local1:GlowFilter = new GlowFilter();
            _local1.color = 0;
            BindingManager.executeBindings(this, "temp", _local1);
            return (_local1);
        }
        private function _RoomWindowUserArea4Mode_Label2_i():Label{
            var _local1:Label = new Label();
            _local1.x = 211;
            _local1.y = 75;
            _local1.id = "userName";
        ...
        private function _RoomWindowUserArea4Mode_Label3_i():Label{
            var _local1:Label = new Label();
            _local1.x = 211;
            _local1.y = 111;
        ...
        private function _RoomWindowUserArea4Mode_Label4_i():Label{
            var _local1:Label = new Label();
            _local1.x = 211;
            _local1.y = 147;
        ...
        private function _RoomWindowUserArea4Mode_Button2_i():Button{
            var _local1:Button = new Button();
            _local1.depth = 5;
            _local1.label = "更换位置";
            _local1.x = 73;
        ...
        public function ___RoomWindowUserArea4Mode_RoomWindowUserArea1_creationComplete(_arg1:FlexEvent):void{
            this.group1_creationCompleteHandler(_arg1);
        }
        private function _RoomWindowUserArea4Mode_bindingsSetup():Array{
            var result:* = [];
            ...
            }, null, "_RoomWindowUserArea4Mode_CommonOuterFrame1.size");
            result[4] = new Binding(this, function ():Array{
                var _local1:* = [326, 262];
                return (((((((_local1 == null)) || ((_local1 is Array)))) || ((_local1 is Proxy)))) ? _local1 : [_local1]);
            }, null, "_RoomWindowUserArea4Mode_CommonMiddleFrame1.size");
            result[5] = new Binding(this, function ():Array{
                var _local1:* = [174, 173];
                return (((((((_local1 == null)) || ((_local1 is Array)))) || ((_local1 is Proxy)))) ? _local1 : [_local1]);
            }, null, "_RoomWindowUserArea4Mode_CommonHeadImageFrame1.size");
            result[6] = new Binding(this, function ():Boolean{
                return (_isMainUserWindow);
            }, null, "_RoomWindowUserArea4Mode_WordWithCircle1.visible");
            return (result);
        }
