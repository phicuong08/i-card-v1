...
package source_manager {
    ...
    public class RoomsListLoadingBar extends WindowSourceLoadingBar implements IBindingClient {
        ...
        public function RoomsListLoadingBar(){
            var target:* = null;
            ...
            super();
            var bindings:* = this._RoomsListLoadingBar_bindingsSetup();
            var watchers:* = [];
            target = this;
            if (_watcherSetupUtil == null){
                watcherSetupUtilClass = getDefinitionByName("_source_manager_RoomsListLoadingBarWatcherSetupUtil");
            ...
            _watcherSetupUtil.setup(this, function (_arg1:String){
                ...
                return (RoomsListLoadingBar[_arg1]);
            }, bindings, watchers);
            mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
            mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
            this.x = 370;
            this.y = 150;
            this.loadingTitle = "载入房间列表...";
            this._RoomsListLoadingBar_Fade1_i();
            this._RoomsListLoadingBar_Fade2_i();
            this.addEventListener("initialize", this.___RoomsListLoadingBar_WindowSourceLoadingBar1_initialize);
            var i:* = 0;
        ...
        public static function set watcherSetupUtil(_arg1:IWatcherSetupUtil2):void{
            RoomsListLoadingBar._watcherSetupUtil = _arg1;
        }
        ...
        protected function fade1_effectStartHandler(_arg1:EffectEvent):void{
            ...
            RoomsListSourceMgr.getInstance().addEventListener(ProgressEvent.PROGRESS, this.loadingProgressHandler);
            RoomsListSourceMgr.getInstance().addEventListener(Event.COMPLETE, this.loadingCompleteHandler);
            RoomsListSourceMgr.getInstance().loadSwfFile();
        }
        ...
        private function loadingCompleteHandler(_arg1:Event=null):void{
            RoomsListSourceMgr.getInstance().removeEventListener(ProgressEvent.PROGRESS, this.loadingProgressHandler);
            RoomsListSourceMgr.getInstance().removeEventListener(Event.COMPLETE, this.loadingCompleteHandler);
        ...
        protected function barCompleteHandler(_arg1:Event):void{
            ...
            this.addEffect.stop();
            if (removeSelf()){
                TCGClient.getInstance().enterRoomsListWindow();
            };
        }
        private function _RoomsListLoadingBar_Fade1_i():Fade{
        ...
        private function _RoomsListLoadingBar_Fade2_i():Fade{
            var _local1:Fade = new Fade();
        ...
        public function ___RoomsListLoadingBar_WindowSourceLoadingBar1_initialize(_arg1:FlexEvent):void{
            alpha = 0;
        }
        private function _RoomsListLoadingBar_bindingsSetup():Array{
            var result:* = [];
