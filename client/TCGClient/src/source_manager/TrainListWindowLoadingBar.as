...
package source_manager {
    ...
    public class TrainListWindowLoadingBar extends WindowSourceLoadingBar implements IBindingClient {
        ...
        public function TrainListWindowLoadingBar(){
            var target:* = null;
            ...
            super();
            var bindings:* = this._TrainListWindowLoadingBar_bindingsSetup();
            var watchers:* = [];
            target = this;
            if (_watcherSetupUtil == null){
                watcherSetupUtilClass = getDefinitionByName("_source_manager_TrainListWindowLoadingBarWatcherSetupUtil");
            ...
            _watcherSetupUtil.setup(this, function (_arg1:String){
                ...
                return (TrainListWindowLoadingBar[_arg1]);
            }, bindings, watchers);
            mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
            mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
            this.x = 370;
            this.y = 150;
            this.loadingTitle = "载入训练界面...";
            this._TrainListWindowLoadingBar_Fade1_i();
            this._TrainListWindowLoadingBar_Fade2_i();
            this.addEventListener("initialize", this.___TrainListWindowLoadingBar_WindowSourceLoadingBar1_initialize);
            var i:* = 0;
        ...
        public static function set watcherSetupUtil(_arg1:IWatcherSetupUtil2):void{
            TrainListWindowLoadingBar._watcherSetupUtil = _arg1;
        }
        ...
        protected function fade1_effectStartHandler(_arg1:EffectEvent):void{
            ...
            TrainListWindowSourceMgr.getInstance().addEventListener(ProgressEvent.PROGRESS, this.loadingProgressHandler);
            TrainListWindowSourceMgr.getInstance().addEventListener(Event.COMPLETE, this.loadingCompleteHandler);
            TrainListWindowSourceMgr.getInstance().loadSwfFile();
        }
        ...
        private function loadingCompleteHandler(_arg1:Event=null):void{
            TrainListWindowSourceMgr.getInstance().removeEventListener(ProgressEvent.PROGRESS, this.loadingProgressHandler);
            TrainListWindowSourceMgr.getInstance().removeEventListener(Event.COMPLETE, this.loadingCompleteHandler);
        ...
        private function _TrainListWindowLoadingBar_Fade1_i():Fade{
        ...
        private function _TrainListWindowLoadingBar_Fade2_i():Fade{
            var _local1:Fade = new Fade();
        ...
        public function ___TrainListWindowLoadingBar_WindowSourceLoadingBar1_initialize(_arg1:FlexEvent):void{
            alpha = 0;
        }
        private function _TrainListWindowLoadingBar_bindingsSetup():Array{
            var result:* = [];
