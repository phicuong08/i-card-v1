...
package source_manager {
    ...
    public class CombatStageLoadingBar extends WindowSourceLoadingBar implements IBindingClient {
        ...
        public function CombatStageLoadingBar(){
            var target:* = null;
            ...
            super();
            var bindings:* = this._CombatStageLoadingBar_bindingsSetup();
            var watchers:* = [];
            target = this;
            if (_watcherSetupUtil == null){
                watcherSetupUtilClass = getDefinitionByName("_source_manager_CombatStageLoadingBarWatcherSetupUtil");
            ...
            _watcherSetupUtil.setup(this, function (_arg1:String){
                ...
                return (CombatStageLoadingBar[_arg1]);
            }, bindings, watchers);
            mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
            mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
            this.x = 370;
            this.y = 150;
            this.loadingTitle = "载入战场资源...";
            this._CombatStageLoadingBar_Fade1_i();
            this._CombatStageLoadingBar_Fade2_i();
            this.addEventListener("initialize", this.___CombatStageLoadingBar_WindowSourceLoadingBar1_initialize);
            var i:* = 0;
        ...
        public static function set watcherSetupUtil(_arg1:IWatcherSetupUtil2):void{
            CombatStageLoadingBar._watcherSetupUtil = _arg1;
        }
        ...
        protected function fade1_effectStartHandler(_arg1:EffectEvent):void{
            ...
            CombatStageSourceMgr.getInstance().addEventListener(ProgressEvent.PROGRESS, this.loadingProgressHandler);
            CombatStageSourceMgr.getInstance().addEventListener(Event.COMPLETE, this.loadingCompleteHandler);
        }
        ...
        private function loadingCompleteHandler(_arg1:Event=null):void{
            CombatStageSourceMgr.getInstance().removeEventListener(ProgressEvent.PROGRESS, this.loadingProgressHandler);
            CombatStageSourceMgr.getInstance().removeEventListener(Event.COMPLETE, this.loadingCompleteHandler);
        ...
        private function _CombatStageLoadingBar_Fade1_i():Fade{
        ...
        private function _CombatStageLoadingBar_Fade2_i():Fade{
            var _local1:Fade = new Fade();
        ...
        public function ___CombatStageLoadingBar_WindowSourceLoadingBar1_initialize(_arg1:FlexEvent):void{
            alpha = 0;
        }
        private function _CombatStageLoadingBar_bindingsSetup():Array{
            var result:* = [];
