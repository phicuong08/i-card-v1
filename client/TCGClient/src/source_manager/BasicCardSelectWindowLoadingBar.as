...
package source_manager {
    ...
    public class BasicCardSelectWindowLoadingBar extends WindowSourceLoadingBar implements IBindingClient {
        ...
        public function BasicCardSelectWindowLoadingBar(){
            var target:* = null;
            ...
            super();
            var bindings:* = this._BasicCardSelectWindowLoadingBar_bindingsSetup();
            var watchers:* = [];
            target = this;
            if (_watcherSetupUtil == null){
                watcherSetupUtilClass = getDefinitionByName("_source_manager_BasicCardSelectWindowLoadingBarWatcherSetupUtil");
            ...
            _watcherSetupUtil.setup(this, function (_arg1:String){
                ...
                return (BasicCardSelectWindowLoadingBar[_arg1]);
            }, bindings, watchers);
            mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
            mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
            this.x = 370;
            this.y = 150;
            this.loadingTitle = "载入选卡界面...";
            this._BasicCardSelectWindowLoadingBar_Fade1_i();
            this._BasicCardSelectWindowLoadingBar_Fade2_i();
            this.addEventListener("initialize", this.___BasicCardSelectWindowLoadingBar_WindowSourceLoadingBar1_initialize);
            var i:* = 0;
        ...
        public static function set watcherSetupUtil(_arg1:IWatcherSetupUtil2):void{
            BasicCardSelectWindowLoadingBar._watcherSetupUtil = _arg1;
        }
        ...
        protected function fade1_effectStartHandler(_arg1:EffectEvent):void{
            ...
            BasicCardSelectWindowSourceMgr.getInstance().addEventListener(ProgressEvent.PROGRESS, this.loadingProgressHandler);
            BasicCardSelectWindowSourceMgr.getInstance().addEventListener(Event.COMPLETE, this.loadingCompleteHandler);
            BasicCardSelectWindowSourceMgr.getInstance().loadSwfFile();
        }
        ...
        private function loadingCompleteHandler(_arg1:Event=null):void{
            BasicCardSelectWindowSourceMgr.getInstance().removeEventListener(ProgressEvent.PROGRESS, this.loadingProgressHandler);
            BasicCardSelectWindowSourceMgr.getInstance().removeEventListener(Event.COMPLETE, this.loadingCompleteHandler);
        ...
        protected function barCompleteHandler(_arg1:Event):void{
            ...
            this.addEffect.stop();
            if (removeSelf()){
                TCGClient.getInstance().showSelectCardWindow();
            };
        }
        private function _BasicCardSelectWindowLoadingBar_Fade1_i():Fade{
        ...
        private function _BasicCardSelectWindowLoadingBar_Fade2_i():Fade{
            var _local1:Fade = new Fade();
        ...
        public function ___BasicCardSelectWindowLoadingBar_WindowSourceLoadingBar1_initialize(_arg1:FlexEvent):void{
            alpha = 0;
        }
        private function _BasicCardSelectWindowLoadingBar_bindingsSetup():Array{
            var result:* = [];
