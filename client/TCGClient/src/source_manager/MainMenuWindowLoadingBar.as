...
package source_manager {
    ...
    public class MainMenuWindowLoadingBar extends WindowSourceLoadingBar implements IBindingClient {
        ...
        public function MainMenuWindowLoadingBar(){
            var target:* = null;
            ...
            super();
            var bindings:* = this._MainMenuWindowLoadingBar_bindingsSetup();
            var watchers:* = [];
            target = this;
            if (_watcherSetupUtil == null){
                watcherSetupUtilClass = getDefinitionByName("_source_manager_MainMenuWindowLoadingBarWatcherSetupUtil");
            ...
            _watcherSetupUtil.setup(this, function (_arg1:String){
                ...
                return (MainMenuWindowLoadingBar[_arg1]);
            }, bindings, watchers);
            mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
            mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
            this.x = 370;
            this.y = 150;
            this.loadingTitle = "载入菜单界面...";
            this._MainMenuWindowLoadingBar_Fade1_i();
            this._MainMenuWindowLoadingBar_Fade2_i();
            this.addEventListener("initialize", this.___MainMenuWindowLoadingBar_WindowSourceLoadingBar1_initialize);
            var i:* = 0;
        ...
        public static function set watcherSetupUtil(_arg1:IWatcherSetupUtil2):void{
            MainMenuWindowLoadingBar._watcherSetupUtil = _arg1;
        }
        ...
        protected function fade1_effectStartHandler(_arg1:EffectEvent):void{
            ...
            MainMenuWindowSourceMgr.getInstance().addEventListener(ProgressEvent.PROGRESS, this.loadingProgressHandler);
            MainMenuWindowSourceMgr.getInstance().addEventListener(Event.COMPLETE, this.loadingCompleteHandler);
            MainMenuWindowSourceMgr.getInstance().loadSwfFile();
        }
        ...
        private function loadingCompleteHandler(_arg1:Event=null):void{
            MainMenuWindowSourceMgr.getInstance().removeEventListener(ProgressEvent.PROGRESS, this.loadingProgressHandler);
            MainMenuWindowSourceMgr.getInstance().removeEventListener(Event.COMPLETE, this.loadingCompleteHandler);
        ...
        private function _MainMenuWindowLoadingBar_Fade1_i():Fade{
        ...
        private function _MainMenuWindowLoadingBar_Fade2_i():Fade{
            var _local1:Fade = new Fade();
        ...
        public function ___MainMenuWindowLoadingBar_WindowSourceLoadingBar1_initialize(_arg1:FlexEvent):void{
            alpha = 0;
        }
        private function _MainMenuWindowLoadingBar_bindingsSetup():Array{
            var result:* = [];
