...
package {
    ...
    public class _combat_element_GraveCardDisplayWindowWatcherSetupUtil implements IWatcherSetupUtil2 {

        public static function init(_arg1:IFlexModuleFactory):void{
            GraveCardDisplayWindow.watcherSetupUtil = new (_combat_element_GraveCardDisplayWindowWatcherSetupUtil)();
        }
