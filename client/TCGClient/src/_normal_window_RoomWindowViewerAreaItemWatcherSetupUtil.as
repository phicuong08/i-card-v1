...
package {
    ...
    public class _normal_window_RoomWindowViewerAreaItemWatcherSetupUtil implements IWatcherSetupUtil2 {

        public static function init(_arg1:IFlexModuleFactory):void{
            RoomWindowViewerAreaItem.watcherSetupUtil = new (_normal_window_RoomWindowViewerAreaItemWatcherSetupUtil)();
        }
