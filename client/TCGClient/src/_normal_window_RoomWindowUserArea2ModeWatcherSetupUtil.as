...
package {
    ...
    public class _normal_window_RoomWindowUserArea2ModeWatcherSetupUtil implements IWatcherSetupUtil2 {

        public static function init(_arg1:IFlexModuleFactory):void{
            RoomWindowUserArea2Mode.watcherSetupUtil = new (_normal_window_RoomWindowUserArea2ModeWatcherSetupUtil)();
        }
