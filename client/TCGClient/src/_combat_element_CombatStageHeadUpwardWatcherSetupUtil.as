...
package {
    ...
    public class _combat_element_CombatStageHeadUpwardWatcherSetupUtil implements IWatcherSetupUtil2 {

        public static function init(_arg1:IFlexModuleFactory):void{
            CombatStageHeadUpward.watcherSetupUtil = new (_combat_element_CombatStageHeadUpwardWatcherSetupUtil)();
        }
