...
package {
    ...
    public class _source_manager_RoomWindowLoadingBarWatcherSetupUtil implements IWatcherSetupUtil2 {

        public static function init(_arg1:IFlexModuleFactory):void{
            RoomWindowLoadingBar.watcherSetupUtil = new (_source_manager_RoomWindowLoadingBarWatcherSetupUtil)();
        }
