...
package {
    ...
    public class _custom_control_MessageBoxWatcherSetupUtil implements IWatcherSetupUtil2 {

        public static function init(_arg1:IFlexModuleFactory):void{
            MessageBox.watcherSetupUtil = new (_custom_control_MessageBoxWatcherSetupUtil)();
        }
