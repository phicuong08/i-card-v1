...
package {
    ...
    public class _source_manager_JudgeCardsLoadingBarWatcherSetupUtil implements IWatcherSetupUtil2 {

        public static function init(_arg1:IFlexModuleFactory):void{
            JudgeCardsLoadingBar.watcherSetupUtil = new (_source_manager_JudgeCardsLoadingBarWatcherSetupUtil)();
        }
