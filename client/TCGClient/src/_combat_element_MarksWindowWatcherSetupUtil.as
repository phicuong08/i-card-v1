...
package {
    ...
    public class _combat_element_MarksWindowWatcherSetupUtil implements IWatcherSetupUtil2 {

        public static function init(_arg1:IFlexModuleFactory):void{
            MarksWindow.watcherSetupUtil = new (_combat_element_MarksWindowWatcherSetupUtil)();
        }
