...
;
        ...
        public function get isMedical():Boolean{
            return ((this.type_id == ItemType.HongYao));
        }
        ...
        public function getItemName(_arg1:int):String{
            if ((((((_arg1 == 0)) || ((_arg1 == 1203)))) || ((this.isEquip == false)))){
                return (this.name);
            };
            return ((this.name + GoldOilType.getOilsSuffix(_arg1)));
        }
