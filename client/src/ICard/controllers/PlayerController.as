...
package ICard.controllers {
    ...
    import ICard.lang.client.com.controllers.*;

    public class PlayerController extends ICard.controllers.Base {
...
//            TownType.campSign = FactionType.campSign(_arg1);
        ...
        public function get isCommonTester():Boolean{
            return true;//return (PlayerType.isCommonTester(this.ownData.tester));
        }
        public function get isAdvancedTester():Boolean{
            return true;//return (PlayerType.isAdvancedTester(this.ownData.tester));
        }
        public function get isGM():Boolean{
            return true;//return (PlayerType.isGM(this.ownData.tester));
        }
        public function get isTrainer():Boolean{
            return true;//return (PlayerType.isTrainer(this.ownData.tester));
        }
        ...
        public function get ingot():int{
            return 0;//((VIPType.enabled) ? this.ownData.ingot : 0);
        }
        public function get ingotString():String{
            var _local1:int = 0;//(VIPType.enabled) ? this.ownData.ingot : 0;
            if (_local1 > 99999){
        ...
        public function get onlineGiftTime():int{
            var _local1:int = 0;//(new Date().getTime() / 1000);
...
//            };
        ...
        public function get serverTime():int{
            var _local1:Number = 0;//(new Date().getTime() / 1000);
