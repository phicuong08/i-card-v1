	...
	dynamic public class Popup extends ICard.views.structure.Base {
		...
		public function closeView(_arg1:IView):void{
			...
			if (this.hasViewIncluded(_arg1, this._freeViews)){
				...
				if (_local3){
					...
					this._viewMgr.cancelCenter(_arg1.sign);
		...
		override public function closeAll():void{
			...
			while (_local2 < _local1.length) {
				...
				this._viewMgr.cancelCenter(_local3.sign);
		...
		public function allowToOpen(_arg1:IView):Boolean{
			...
			//            if ((((this._viewMgr.townMap.inStage == false)) && (this.hasViewIncluded((_local2 as IView), this._inTownViews)))){
			//                return (false);
			//            };
			return (true);
		}
		...
		private function removeFadeOutList(_arg1:IView):void{
			if (this._fadeOutList[_arg1]){
				...
				//                    this._viewMgr.toolbar.functionBarParent = null;
				//                };
			};
		}
