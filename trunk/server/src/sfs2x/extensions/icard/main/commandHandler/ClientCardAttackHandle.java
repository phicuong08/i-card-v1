...
public class ClientCardAttackHandle extends BaseClientRequestHandler {
	...
	public void handleClientRequest(User paramUser, ISFSObject paramISFSObject) {
			...
			CardActionBean action = new CardActionBean(srcID,paramUser.getId(),CardActionBean.DO_CARD_2_ATK,des);
