...
public class UserLeavedRoomEventHandler extends BaseServerEventHandler {
	...
	public void handleServerEvent(ISFSEvent event) throws SFSException {
		...
		trace("icard: user " + user.getName() + " leave the game room '" + room.getName() + "' - game room id: " + room.getId());
