...
// Main
// 
// This is the BattleFarm document class that handles the states of the game. 
...
package sfs2x.games.battlefarm
{
	...
	// Import custom BattleFarm classes
	import sfs2x.games.battlefarm.scenes.*;
	...
	public class Main extends MovieClip 
	{
		...
		{			
			this.stop();
			preloader.addEventListener(Event.COMPLETE, initBattleFarm);
		}
		
		/**
		 * When loading is complete, initialize BattleFarm
		 */
		private function initBattleFarm(evt:Event):void 
		{
			d_trace("Main - initBattleFarm");
			
			// Remove the preloader
			preloader.removeEventListener(Event.COMPLETE , initBattleFarm);
