...
package sfs2x.games.ICard
{
	...
	/**
	 * ICard document class
	 */
	public class ICard extends MovieClip 
	{
		// SmartFox ICard instance
		...
		{
			d_trace("ICard - onConnectionLost");
				
			// If current scene is lobby
			if (chatScene != null)
			{
				d_trace("ICard - onConnectionLost - remove chat scene");
			...
			if (gameScene != null)
			{
				d_trace("ICard - onConnectionLost - remove game scene");
		...
		{
			d_trace("ICard - playSoundtrack - " + vol);
