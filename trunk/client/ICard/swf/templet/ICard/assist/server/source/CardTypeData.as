    ...
    public class CardTypeData {
        ...
        public static const HeroCards:Object = {
        		//编号	名称	         阵营	  种族	费用 血量	能力
						20001:[20001,"亮须波瑞斯"  ,"阵营","种族", 0,  26,"X，翻转亮须波瑞斯→波瑞斯对目标英雄或盟军治疗X点伤害。此能力只能在你的回合中使用。"],
						20002:[20002,"迪兹莫娜"    ,"阵营","种族", 0,  28,"③，翻转迪兹莫娜，在她身上放置X点伤害→迪兹莫娜对目标盟盟军造成X点暗影伤害。此能力只能在你的回合中使用。"],
						20003:[20003,"艾伦德尔"    ,"阵营","种族", 0,  28,"①，翻转艾伦德尔→你的远程武器本回合得到+3攻击力。"],
						20004:[20004,"格拉库斯"    ,"阵营","种族", 0,  29,"③，翻转格拉库斯→防止本回合将对目标英雄或盟军接下来的3点伤害。"],
						20005:[20005,"燃霜莉特瑞"  ,"阵营","种族", 0,  25,"②，翻转燃霜莉特瑞→目标英雄或盟军本回合不能攻击。"]
        };
        public static const SkillCards:Object = {
            //编号	名称	         阵营	  种族	费用	能力
        		50001:[50001,"纠缠根须"    ,"中立","种族", 2,   "结附目标盟军，将其横置。持续：被结附的盟军在其操控者重置步骤中不能被重置。"],
        		50002:[50002,"治疗之触"    ,"中立","种族", 3,   "你的英雄对目标英雄或盟军治疗10点伤害。"],
        		50003:[50003,"自然选择"    ,"中立","种族", 3,   "选择一项：你的英雄对目标英雄或盟军造成3点自然伤害；或你的英雄对目标英雄或盟军治疗3点伤害。"],
        		50004:[50004,"愈合"        ,"中立","种族", 1,   "结附目标盟军，你的英雄对其治疗2点伤害。持续：在每个回合结束时，你的英雄对被结附盟军治疗1点伤害。"],
        		50005:[50005,"瞄准射击"    ,"中立","种族", "1+X", "你的英雄对目标英雄或盟军造成X点远程伤害。"],
        		50006:[50006,"奥术射击"    ,"中立","种族", 2,   "你的英雄对目标英雄或盟军造成1点奥术伤害。装一张牌。"],
        		50007:[50007,"死亡标记"    ,"中立","种族", 2,   "结附目标对方英雄或盟军。持续：你队伍中的盟军攻击被结附者时得到+1攻击力。"],
        		50008:[50008,"多重射击"    ,"中立","种族", 5,   "你的英雄对最多单个目标英雄或盟军各造成2点远程伤害。"],
        		50009:[50009,"魔法反制"    ,"中立","种族", 2,   "打断目标技能。"]
        };
     		public static const TaskCards:Object = {
     				//编号	名称						阵营     种族	    能力
				40001:[40001,"迪菲亚兄弟会"   ,"中立","种族",   "当你队伍中有四个或以上的盟军时，支付①完成此任务。奖励：抓两张牌"],
        		40002:[40002,"人马无双"       ,"中立","种族",   "当对方任一队伍中的盟军数比你队伍的盟军数多时，支付③完成此任务。奖励：抓两张牌。"],
        		40003:[40003,"为部落而战"     ,"中立","种族",   "支付①完成此任务。奖励：你队伍中的部落盟军本回合攻击时得到+1攻击力。"],
        		40004:[40004,"托雷克的突袭"   ,"中立","种族",   "如果任一对方英雄本回合曾受到你队伍中的任一盟军造成的伤害时，支付①完成此任务。奖励：抓一张牌"],
        		40005:[40005,"达隆郡的战斗"   ,"中立","种族",　 "将你坟墓场中三张盟军牌移出游戏并支付①完成此任务。奖励：抓一张牌。"],
        		40006:[40006,"王牌猎人"    	  ,"中立","种族",   "支付②完成此任务。奖励：展示你牌库顶四张牌，将一张被展示的装备牌置于你手上并将其余牌置于你牌库底。"],
        		40007:[40007,"蓝叶薯"         ,"中立","种族",   "支付②完成此任务。奖励：将你的坟墓场洗入你的牌库。"],
        		40008:[40008,"捐献毛料"       ,"中立","种族",   "支付①完成此任务。奖励：抓一张牌，然后弃一张牌。"],
        		40009:[40009,"在梦中"         ,"中立","种族",   "支付⑧完成此任务。奖励：抓三张牌。"],
        		40010:[40010,"深入疯狂之口"   ,"中立","种族",   "消灭深入疯狂之口完成此任务。奖励：抓一张牌。"]
     		};
        ...
        public static const WeaponCards:Object = {
				...
				30001:[30001,"上古骨弓"        ,"中立","种族",   3,   2,       2,     "当你使用上古骨弓进行打击时，你的英雄在此次战斗中具有远程攻击（防御者不会对你造成战斗伤害）。"],
        		...
        		30005:[30005,"碎灵"            ,"中立","种族",　 4,   2,       3,     "当你的英雄使用碎灵对任一英雄造成战斗伤害时，该英雄操控者弃一张牌。"],
        		30006:[30006,"提米的手"        ,"中立","种族",   5,   3,       2,     "当你的英雄使用提米的手对任一英雄造成战斗伤害时，该英雄操控者消灭他的一个资源"],
        		30007:[30007,"命运"            ,"中立","种族",   3,   2,       1,     "当你的英雄使用命运造成战斗伤害时，在命运上放置一个力量示物。命运上每有一个力量示物，他便得到+1攻击力。"]
        };
        public static const SoldierCards:Object = {
        		...
        		21008:[21008,"缝合憎恶"       ,"中立",   "DPS",   4,   0,       0,     "在你的坟墓场每有一张盟军牌，缝合憎恶得到+1攻击力和+1生命值。当缝合憎恶被造成伤害时，将你墓地中与伤害同等数量的盟军牌移出游戏。然后，每将一个盟军移出游戏，则在缝合憎恶身上移去1点伤害。"],
