    ...
    public class CardTypeData {
        ...
        public static const SkillCards:Object = {
     		...
     		public static const TaskCards:Object = {
     			40000:["编号",	"任务  ",       "阵营  ","种族  ",  "能力  "],
				40001:[40001,"迪菲亚兄弟会"   ,"中立","种族",             "当你队伍中有四个或以上的盟军时，支付①完成此任务。<br>奖励：抓两张牌"],
        		40002:[40002,"人马无双"       ,"中立","种族",             "当对方任一队伍中的盟军数比你队伍的盟军数多时，<br>支付③完成此任务。奖励：抓两张牌。"],
        		40003:[40003,"为部落而战"     ,"中立","种族",             "支付①完成此任务。奖励：你队伍中的部落盟军本回合<br>攻击时得到+1攻击力。"],
        		40004:[40004,"托雷克的突袭"   ,"中立","种族",             "如果任一对方英雄本回合曾受到你队伍中的任一盟军造<br>成的伤害时，支付①完成此任务。奖励：抓一张牌"],
        		40005:[40005,"达隆郡的战斗"   ,"中立","种族",　           "将你坟墓场中三张盟军牌移出游戏并支付①完成此任务。<br>奖励：抓一张牌。"],
        		40006:[40006,"王牌猎人"    	  ,"中立","种族",             "支付②完成此任务。奖励：展示你牌库顶四张牌，将一张<br>被展示的装备牌置于你手上并将其余牌置于你牌库底。"],
