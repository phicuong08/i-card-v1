...
package ICard.assist.server.source {
    ...
    public class CardTypeData {
        ...
        public static const HeroCards:Object = {
						20000:["编号","英雄  "	    ,"阵营		"	,"种族		"	,"耗能  "	,"最大能量  "	,"血量  "	,"能力  "],
						20001:[20001,"亮须波瑞斯"  	,"阵营"		 	,"种族"			,5				,10						,26				,"X，翻转亮须波瑞斯→波瑞斯对目标英雄或盟军治疗X点<br>伤害。此能力只能在你的回合中使用。"],
						20002:[20002,"迪兹莫娜"    	,"阵营"		 	,"种族"			,3				,10						,28				,"③，翻转迪兹莫娜，在她身上放置X点伤害→迪兹莫娜对<br>目标盟盟军造成X点暗影伤害。此能力只能在你的回合中使用。"],
						20003:[20003,"艾伦德尔"    	,"阵营"		 	,"种族"			,2				,10						,28				,"①，翻转艾伦德尔→你的远程武器本回合得到+3攻击力。"],
						20004:[20004,"格拉库斯"    	,"阵营"		 	,"种族"			,3				,10						,29				,"③，翻转格拉库斯→防止本回合将对目标英雄或盟军接下<br>来的3点伤害。"],
						20005:[20005,"燃霜莉特瑞"  	,"阵营"		 	,"种族"			,2				,10						,25				,"②，翻转燃霜莉特瑞→目标英雄或盟军本回合不能攻击。"],
						20006:[20006,"普贤真人"			,"阵营"			,"种族"			,3				,10						,26				,"目标我方单位得到3点治疗。"],
						20007:[20007,"黑山老妖"			,"阵营"			,"种族"			,4				,10						,30				,"消灭目标装备或者Support卡片。"],
						20008:[20008,"总兵李靖"			,"阵营"			,"种族"			,4				,10						,30				,"本回合武器获得+1攻击力，如果武器对盟军造成伤害，该盟军被消灭。"],
						20009:[20009,"广成子"				,"阵营"			,"种族"			,3				,10						,28				,"对2个敌方单位造成2点伤害。"],
						20010:[20010,"太上老君"			,"阵营"			,"种族"			,4				,10						,26				,"对目标单位造成3点伤害，并抓张卡牌。"],
						20011:[20011,"金轮法王"			,"阵营"			,"种族"			,4				,10						,26				,"坟场的目标牌回到手牌。"]
        };
