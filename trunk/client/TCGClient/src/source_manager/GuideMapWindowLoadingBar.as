...
package source_manager {
    ...
    public class GuideMapWindowLoadingBar extends WindowSourceLoadingBar implements IBindingClient {
        ...
        public function GuideMapWindowLoadingBar(){
            var target:* = null;
            ...
            super();
            var bindings:* = this._GuideMapWindowLoadingBar_bindingsSetup();
            var watchers:* = [];
            target = this;
            if (_watcherSetupUtil == null){
                watcherSetupUtilClass = getDefinitionByName("_source_manager_GuideMapWindowLoadingBarWatcherSetupUtil");
            ...
            _watcherSetupUtil.setup(this, function (_arg1:String){
                ...
                return (GuideMapWindowLoadingBar[_arg1]);
            }, bindings, watchers);
            mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
            mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
            this.x = 370;
            this.y = 150;
            this.loadingTitle = "载入战役界面...";
            this._GuideMapWindowLoadingBar_Fade1_i();
            this._GuideMapWindowLoadingBar_Fade2_i();
            this.addEventListener("initialize", this.___GuideMapWindowLoadingBar_WindowSourceLoadingBar1_initialize);
            var i:* = 0;
        ...
        public static function set watcherSetupUtil(_arg1:IWatcherSetupUtil2):void{
            GuideMapWindowLoadingBar._watcherSetupUtil = _arg1;
        }
        ...
        protected function fade1_effectStartHandler(_arg1:EffectEvent):void{
            ...
            GuideMapWindowSourceMgr.getInstance().addEventListener(ProgressEvent.PROGRESS, this.loadingProgressHandler);
            GuideMapWindowSourceMgr.getInstance().addEventListener(Event.COMPLETE, this.loadingCompleteHandler);
            GuideMapWindowSourceMgr.getInstance().loadSwfFile();
        }
        ...
        private function loadingCompleteHandler(_arg1:Event=null):void{
            GuideMapWindowSourceMgr.getInstance().removeEventListener(ProgressEvent.PROGRESS, this.loadingProgressHandler);
            GuideMapWindowSourceMgr.getInstance().removeEventListener(Event.COMPLETE, this.loadingCompleteHandler);
        ...
        private function _GuideMapWindowLoadingBar_Fade1_i():Fade{
        ...
        private function _GuideMapWindowLoadingBar_Fade2_i():Fade{
            var _local1:Fade = new Fade();
        ...
        public function ___GuideMapWindowLoadingBar_WindowSourceLoadingBar1_initialize(_arg1:FlexEvent):void{
            alpha = 0;
        }
        private function _GuideMapWindowLoadingBar_bindingsSetup():Array{
            var result:* = [];
