...
package source_manager {
    ...
    public class CompetitionHallLoadingBar extends WindowSourceLoadingBar implements IBindingClient {
        ...
        public function CompetitionHallLoadingBar(){
            var target:* = null;
            ...
            super();
            var bindings:* = this._CompetitionHallLoadingBar_bindingsSetup();
            var watchers:* = [];
            target = this;
            if (_watcherSetupUtil == null){
                watcherSetupUtilClass = getDefinitionByName("_source_manager_CompetitionHallLoadingBarWatcherSetupUtil");
            ...
            _watcherSetupUtil.setup(this, function (_arg1:String){
                ...
                return (CompetitionHallLoadingBar[_arg1]);
            }, bindings, watchers);
            mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
            mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
            this.x = 370;
            this.y = 150;
            this.loadingTitle = "载入竞赛大厅...";
            this._CompetitionHallLoadingBar_Fade1_i();
            this._CompetitionHallLoadingBar_Fade2_i();
            this.addEventListener("initialize", this.___CompetitionHallLoadingBar_WindowSourceLoadingBar1_initialize);
            var i:* = 0;
        ...
        public static function set watcherSetupUtil(_arg1:IWatcherSetupUtil2):void{
            CompetitionHallLoadingBar._watcherSetupUtil = _arg1;
        }
        ...
        protected function fade1_effectStartHandler(_arg1:EffectEvent):void{
            ...
            CompetitionHallSourceMgr.getInstance().addEventListener(ProgressEvent.PROGRESS, this.loadingProgressHandler);
            CompetitionHallSourceMgr.getInstance().addEventListener(Event.COMPLETE, this.loadingCompleteHandler);
            CompetitionHallSourceMgr.getInstance().loadSwfFile();
        }
        ...
        private function loadingCompleteHandler(_arg1:Event=null):void{
            CompetitionHallSourceMgr.getInstance().removeEventListener(ProgressEvent.PROGRESS, this.loadingProgressHandler);
            CompetitionHallSourceMgr.getInstance().removeEventListener(Event.COMPLETE, this.loadingCompleteHandler);
        ...
        protected function barCompleteHandler(_arg1:Event):void{
            ...
            this.addEffect.stop();
            if (removeSelf()){
                TCGClient.getInstance().enterCompetitionHall();
            };
        }
        private function _CompetitionHallLoadingBar_Fade1_i():Fade{
        ...
        private function _CompetitionHallLoadingBar_Fade2_i():Fade{
            var _local1:Fade = new Fade();
        ...
        public function ___CompetitionHallLoadingBar_WindowSourceLoadingBar1_initialize(_arg1:FlexEvent):void{
            alpha = 0;
        }
        private function _CompetitionHallLoadingBar_bindingsSetup():Array{
            var result:* = [];
