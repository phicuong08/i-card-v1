...
package source_manager {
    ...
    public class JudgeCardsLoadingBar extends WindowSourceLoadingBar implements IBindingClient {
        ...
        public function JudgeCardsLoadingBar(){
            var target:* = null;
            ...
            super();
            var bindings:* = this._JudgeCardsLoadingBar_bindingsSetup();
            var watchers:* = [];
            target = this;
            if (_watcherSetupUtil == null){
                watcherSetupUtilClass = getDefinitionByName("_source_manager_JudgeCardsLoadingBarWatcherSetupUtil");
            ...
            _watcherSetupUtil.setup(this, function (_arg1:String){
                ...
                return (JudgeCardsLoadingBar[_arg1]);
            }, bindings, watchers);
            mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
            mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
            this.x = 370;
            this.y = 150;
            this.loadingTitle = "载入组卡界面...";
            this._JudgeCardsLoadingBar_Fade1_i();
            this._JudgeCardsLoadingBar_Fade2_i();
            this.addEventListener("initialize", this.___JudgeCardsLoadingBar_WindowSourceLoadingBar1_initialize);
            var i:* = 0;
        ...
        public static function set watcherSetupUtil(_arg1:IWatcherSetupUtil2):void{
            JudgeCardsLoadingBar._watcherSetupUtil = _arg1;
        }
        ...
        private function _JudgeCardsLoadingBar_Fade1_i():Fade{
        ...
        private function _JudgeCardsLoadingBar_Fade2_i():Fade{
            var _local1:Fade = new Fade();
        ...
        public function ___JudgeCardsLoadingBar_WindowSourceLoadingBar1_initialize(_arg1:FlexEvent):void{
            alpha = 0;
        }
        private function _JudgeCardsLoadingBar_bindingsSetup():Array{
            var result:* = [];
