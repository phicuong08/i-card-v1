...
package source_manager {
    ...
    public class RoomWindowLoadingBar extends WindowSourceLoadingBar implements IBindingClient {
        ...
        public function RoomWindowLoadingBar(){
            var target:* = null;
            ...
            super();
            var bindings:* = this._RoomWindowLoadingBar_bindingsSetup();
            var watchers:* = [];
            target = this;
            if (_watcherSetupUtil == null){
                watcherSetupUtilClass = getDefinitionByName("_source_manager_RoomWindowLoadingBarWatcherSetupUtil");
            ...
            _watcherSetupUtil.setup(this, function (_arg1:String){
                ...
                return (RoomWindowLoadingBar[_arg1]);
            }, bindings, watchers);
            mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
            mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
            this.x = 370;
            this.y = 150;
            this.loadingTitle = "载入房间界面...";
            this._RoomWindowLoadingBar_Fade1_i();
            this._RoomWindowLoadingBar_Fade2_i();
            this.addEventListener("initialize", this.___RoomWindowLoadingBar_WindowSourceLoadingBar1_initialize);
            var i:* = 0;
        ...
        public static function set watcherSetupUtil(_arg1:IWatcherSetupUtil2):void{
            RoomWindowLoadingBar._watcherSetupUtil = _arg1;
        }
        ...
        protected function fade1_effectStartHandler(_arg1:EffectEvent):void{
            ...
            RoomWindowSourceMgr.getInstance().addEventListener(ProgressEvent.PROGRESS, this.loadingProgressHandler);
            RoomWindowSourceMgr.getInstance().addEventListener(Event.COMPLETE, this.loadingCompleteHandler);
            RoomWindowSourceMgr.getInstance().loadSwfFile();
        }
        ...
        private function loadingCompleteHandler(_arg1:Event=null):void{
            RoomWindowSourceMgr.getInstance().removeEventListener(ProgressEvent.PROGRESS, this.loadingProgressHandler);
            RoomWindowSourceMgr.getInstance().removeEventListener(Event.COMPLETE, this.loadingCompleteHandler);
        ...
        private function _RoomWindowLoadingBar_Fade1_i():Fade{
        ...
        private function _RoomWindowLoadingBar_Fade2_i():Fade{
            var _local1:Fade = new Fade();
        ...
        public function ___RoomWindowLoadingBar_WindowSourceLoadingBar1_initialize(_arg1:FlexEvent):void{
            alpha = 0;
        }
        private function _RoomWindowLoadingBar_bindingsSetup():Array{
            var result:* = [];
