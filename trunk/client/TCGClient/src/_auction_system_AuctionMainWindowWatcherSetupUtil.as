...
package {
    ...
    public class _auction_system_AuctionMainWindowWatcherSetupUtil implements IWatcherSetupUtil2 {

        public static function init(_arg1:IFlexModuleFactory):void{
            AuctionMainWindow.watcherSetupUtil = new (_auction_system_AuctionMainWindowWatcherSetupUtil)();
        }
