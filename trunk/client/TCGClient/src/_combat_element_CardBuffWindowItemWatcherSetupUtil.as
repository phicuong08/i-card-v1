...
package {
    ...
    public class _combat_element_CardBuffWindowItemWatcherSetupUtil implements IWatcherSetupUtil2 {

        public static function init(_arg1:IFlexModuleFactory):void{
            CardBuffWindowItem.watcherSetupUtil = new (_combat_element_CardBuffWindowItemWatcherSetupUtil)();
        }
