...
package {
    ...
    public class _combat_element_SelectCardYesOrNoWatcherSetupUtil implements IWatcherSetupUtil2 {

        public static function init(_arg1:IFlexModuleFactory):void{
            SelectCardYesOrNo.watcherSetupUtil = new (_combat_element_SelectCardYesOrNoWatcherSetupUtil)();
        }
