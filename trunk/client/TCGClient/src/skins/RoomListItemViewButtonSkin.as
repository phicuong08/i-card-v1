...
package skins {
    ...
    public class RoomListItemViewButtonSkin extends SparkSkin implements IStateClient2 {
        ...
        private var _embed_mxml_source_buttonImages______png_536657508:Class;
        private var _213507019hostComponent:Button;

        public function RoomListItemViewButtonSkin(){
            this._embed_mxml_source_buttonImages______png_536657508 = RoomListItemViewButtonSkin__embed_mxml_source_buttonImages______png_536657508;
            super();
            this.filters = [this._RoomListItemViewButtonSkin_ColorMatrixFilter1_i()];
            this.mxmlContent = [this._RoomListItemViewButtonSkin_SmoothImage1_i(), this._RoomListItemViewButtonSkin_Label1_i()];
            this.currentState = "up";
            this.addEventListener("creationComplete", this.___RoomListItemViewButtonSkin_SparkSkin1_creationComplete);
            this.addEventListener("currentStateChange", this.___RoomListItemViewButtonSkin_SparkSkin1_currentStateChange);
            states = [new State({
                name:"up",
                overrides:[]
            }), new State({
        ...
        private function _RoomListItemViewButtonSkin_ColorMatrixFilter1_i():ColorMatrixFilter{
        ...
        private function _RoomListItemViewButtonSkin_SmoothImage1_i():SmoothImage{
            var _local1:SmoothImage = new SmoothImage();
            _local1.source = this._embed_mxml_source_buttonImages______png_536657508;
        ...
        private function _RoomListItemViewButtonSkin_Label1_i():Label{
            var _local1:Label;
            _local1 = new Label();
            _local1.text = "观战";
            _local1.x = 29;
        ...
        public function ___RoomListItemViewButtonSkin_SparkSkin1_creationComplete(_arg1:FlexEvent):void{
            this.sparkskin1_creationCompleteHandler(_arg1);
        }
        public function ___RoomListItemViewButtonSkin_SparkSkin1_currentStateChange(_arg1:StateChangeEvent):void{
