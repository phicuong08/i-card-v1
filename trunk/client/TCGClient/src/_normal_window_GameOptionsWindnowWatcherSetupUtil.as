...
package {
    ...
    public class _normal_window_GameOptionsWindnowWatcherSetupUtil implements IWatcherSetupUtil2 {

        public static function init(_arg1:IFlexModuleFactory):void{
            GameOptionsWindnow.watcherSetupUtil = new (_normal_window_GameOptionsWindnowWatcherSetupUtil)();
        }
