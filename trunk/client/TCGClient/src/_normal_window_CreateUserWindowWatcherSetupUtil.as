...
package {
    ...
    public class _normal_window_CreateUserWindowWatcherSetupUtil implements IWatcherSetupUtil2 {

        public static function init(_arg1:IFlexModuleFactory):void{
            CreateUserWindow.watcherSetupUtil = new (_normal_window_CreateUserWindowWatcherSetupUtil)();
        }
