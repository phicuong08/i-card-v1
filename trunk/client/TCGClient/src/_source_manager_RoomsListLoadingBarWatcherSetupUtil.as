...
package {
    ...
    public class _source_manager_RoomsListLoadingBarWatcherSetupUtil implements IWatcherSetupUtil2 {

        public static function init(_arg1:IFlexModuleFactory):void{
            RoomsListLoadingBar.watcherSetupUtil = new (_source_manager_RoomsListLoadingBarWatcherSetupUtil)();
        }
