...
package {
    ...
    public class _normal_window_RegisterWindowWatcherSetupUtil implements IWatcherSetupUtil2 {

        public static function init(_arg1:IFlexModuleFactory):void{
            RegisterWindow.watcherSetupUtil = new (_normal_window_RegisterWindowWatcherSetupUtil)();
        }
