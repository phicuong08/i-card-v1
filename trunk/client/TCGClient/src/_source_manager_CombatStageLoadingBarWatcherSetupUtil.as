...
package {
    ...
    public class _source_manager_CombatStageLoadingBarWatcherSetupUtil implements IWatcherSetupUtil2 {

        public static function init(_arg1:IFlexModuleFactory):void{
            CombatStageLoadingBar.watcherSetupUtil = new (_source_manager_CombatStageLoadingBarWatcherSetupUtil)();
        }
